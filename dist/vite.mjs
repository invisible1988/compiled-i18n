...
import { replaceGlobals, transformLocalize } from "./transform-localize.mjs";
import { scanUsageKeys } from "./scan-usage.mjs";
  ...
  return [
    {
      ...
      configResolved(config) {
        ...
        localesDirNode = sep !== "/" ? localesDirAbs.replaceAll(sep, "/") : localesDirAbs;
